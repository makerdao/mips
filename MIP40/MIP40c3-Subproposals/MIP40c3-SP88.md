...
- Providing the protocol control over funds held in the Auditor Wallet and Operational Wallet.
- Reducing governance overhead to a minimum.
- Providing full transparency and be kept in check by a group of trusted auditors.

Therefore, a vote to ratify this MIP means MKR holders make a commitment to:

- Streaming the annual budget for TECH-001 using DssVest for one year.
...
A total maximum of 1,666,722 DAI (NewBase) or 1,368,924 DAI (NewBear) will be streamed to `0x2dC0420A736D1F40893B9481D8968E4D7424bC0B` starting 2023-04-01 and ending 2024-03-31.
...
This budget cap secures a team of 5.7 full-time employees (FTE) (NewBase) or 4.7 FTE (NewBear), critical infrastructure and tools, as well as covering all other operational costs listed in the table below.
...
Most of the value we deliver to the protocol is outlined in [MIP39c2-SP29: Adding TechOps Core Unit MIP](https://mips.makerdao.com/mips/details/MIP39c2SP29). Additionally and taking the recent developments and prioritization by governance into the account:
...
- Protocol Engineering CU L2 (Optimism and Arbitrum) expansion support.
...
The current team will be composed of nine contributors at 5.7 FTE (NewBase) or 4.7 FTE (NewBear) total. We are hoping to retain the current team without any new hires in the new year.
...
- No new hires in the new year.
   - Consequences and risks: no improvements to infrastructure decentralization and timezone coverage (bear).
...
- Fewer off-sites and conferences.
...
Taking into account the complexity of monitoring and infrastructure and necessity of handover, it is expected that the unwinding process for TechOps Core Unit might take up to six months or more.
