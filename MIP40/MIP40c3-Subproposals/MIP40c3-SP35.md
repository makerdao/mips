...
There will be three (3) multisig wallets each of which will serve a separate function, and which will be identified as: the Deco Operational Wallet, the Deco Protocol Wallet, and the Deco Reserves Wallet. 
...
3) The Deco Reserves Wallet:
The Deco Reserves Wallet is a 2-out-of-3 multi-sig wallet controlled by trusted MakerDAO members composed of representatives from core units outside of the Deco Core Unit. Initially, the proposed signers are to be SES Core Unit members similarly to current incubator implementations. This wallet provides a buffer of three (3) months for ongoing core unit operations to insure uninterrupted operations.
**Address: 0xF482D1031E5b172D42B2DAA1b6e5Cbf6519596f7**

#### Monthly Budget Statement 
Within the first 5 days of each month, the Deco Core Unit will submit a Monthly Budget Statement to the signers of the Reserves Wallet which will include the following information: 
...
4) **The Transfer Amounts.** This category will show a breakdown of the distribution of funds from each wallet for the prior month (the Protocol Wallet and the Reserves Wallet), as well as any top-up required from the MakerDAO to the Reserves wallet.

#### Monthly Top-up Cycle
The following describes the planned financial cycle for a month of operations for the Deco Core Unit. 

1) Within the first 5 days of a new month, the Monthly Budget Statement from the previous calendar month is submitted to the signers of the Deco Reserves Wallet.
...
3) In parallel, the Deco Core Unit submits the necessary transaction requests to the Deco Reserves Wallet.
...
4) The Reserves Wallet will always stream three months of budget as a buffer until the term of the MIP has concluded. 
...
#### Continuous Funding Model Reserves

The three-month Reserve Wallet is to be held as an ongoing buffer and transferred to the Deco Operational Wallet Core Unit as scheduled to assure continuity of operation, and if the Core Unit is terminated by MakerDAO, regardless of reason, to assure an orderly winddown of the unit. 



#### Initial Seed Transfer

The initial seed transfer shall be $428,125 DAI and sent to the Reserves Wallet upon vote approval of Deco’s Core Unit MIP. 
...
**Recipient:** Reserves Wallet: 0xF482D1031E5b172D42B2DAA1b6e5Cbf6519596f7

#### November 1, 2021, Transfer

The Deco Reserves Wallet signers will manually transfer one month’s operating budget floor to the Deco Operations Wallet upon receipt. 
...
**Sender:** Reserves Wallet: 0xF482D1031E5b172D42B2DAA1b6e5Cbf6519596f7
