...
The Responsible Facilitators of the Governance Security Scope are responsible for adhering to the contents of the Scope Framework elements.
...
The Responsible Facilitator Core Units for the Governance Security Scope are defined in MIP114c3.

## MIP114c4: Active Responsible Facilitator Core Unit list

The current active Responsible Facilitator Core Units of the Governance Security Scope are:
* TBD

## MIP114c5: Active Responsible Facilitator Core Unit list modification sub proposal process

This component is a sub proposal process component that, if approved by Maker Governance, modifies the state of MIP114c4 from line 14 until the end of the MIP Component.

## MIP114c6: Scope Framework Articles modification Sub Proposal process
