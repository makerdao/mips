...
The yearly total AVC Member participation rewards is 1 million NewGovToken. This amount is broken into tranches of 50000 NewGovToken for each Scope per quarterly governance cycle, and shared across the reward slots for that Scope.
...
The PD slots share a total of 3 million NewGovToken per year amongst them.

##### 2.6.3.10:

The RD slots share a total of 1 million NewGovToken per year amongst them.
...
2 million NewGovToken is distributed according to Budget Weight.
...
SubDAO Scope FacilitatorDAO Responsibility Rewards
