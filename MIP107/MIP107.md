...
Protocol Advisory Council Requirements

###### 1.1.1.5.1

Protocol Advisory Council members can be individuals, groups of people, legal entities, or companies. They can be anonymous, pseudonymous, or known entities. Protocol Advisory Council members must be aligned with the long-term goals of MakerDAO Endgame.
