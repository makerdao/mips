...
##### 3.1: Legal Defense Defense Bodies
...
* **3.1.1:** The Legal Defense Fund
The Legal Defense Fund (LDF) is a self-insurance instrument fully controlled by Maker Governance which will cover legal defense expenses in case of legal or regulatory action against the DAO or active participants in the Maker ecosystem. 
The LDF will be the primary source for direct legal defense funding.
The conditions of use are defined in Claim Protocol (1.3).
  * **3.1.1.1:** The budget of the Legal Defense Fund is defined in *3.1.1.1.1A*. The Physical Resilience Facilitator can propose to pay out the budget manually through weekly cycle, according to the rules related to claims described in this Section. The Physical Resilience Facilitator can propose modifications to *3.1.1.1.1A* through the weekly cycle.
    * **3.1.1.1.1A:**
¤¤¤
The current active budget for the Legal Defense Fund is:
5000000 Dai per year, with the full amount available at the start of each calendar year.
¤¤¤

##### 3.2 The Legal Defense Technical Committee
The Legal Defense Technical Committee is a group of Ecosystem Actors that provide advice on assessing claims against the LDF and advice on further development of the fund and risk management topics.
* **3.2.1:** Members of the Legal Defense Technical Committee are selected and paid for services on a project basis by the Physical Resilience Facilitator. The budget for this the Legal Defense Fund budget specified in *3.1.1.1.1A*. *This is later intended to move to a separate budget.*
---
* **3.2.2:** The members of the Legal Defense Technical Committee must fulfill the following requirements:
...
* **3.3.1:** Lawyer Registry Acceptance Criteria. Lawyers that are included in the Lawyer Registry must fulfill the requirements described in the following subelements.
  * **3.3.1.1:**Licensed legal professional in their respective jurisdiction.
  * **3.3.1.2:**Proven experience with MakerDAO or crypto.
  * **3.3.1.3:**No Conflict of Interest.
---
...
¤¤¤
##### 3.4: Legal Defense Claims process
This section will govern the conditions and terms of use of the Legal Defense Fund.
* **3.4.1:** The Legal Defense Process covers legal defense or legal representation expenses incurred by a participant of the Maker Ecosystem when they are the target of a legal or regulatory action. There must be a direct relationship between the legal or regulatory action and the Beneficiary’s activity at MakerDAO. A (Non - exhaustive) list of legal or regulatory actions that may qualify are described in the following subelements. 
  * **3.4.1.1:** Official requirements from a regulatory body or a court
  * **3.4.1.2:** Subpoenas
  * **3.4.1.3:** Lawsuit 
  * **3.4.1.4:** Writs
---
* **3.4.2:** The cases specified in the following subelements will generally be excluded from coverage by the legal defense process.
  * **3.4.2:** Prior or pending claims.
  * **3.4.2:** Claims between persons involved in the Maker ecosystem.
  * **3.4.2:** Loss covered by other insurance. 
  * **3.4.2:** Criminal cases.
  * **3.4.2:** Conflict of Interest.
---
* **3.4.3:** Eligible beneficiaries are natural persons who fulfill the following requirements:
...
---
* **3.4.4:** *Onboarding process Legal Defense Process*
...
The Physical Resilience Facilitators must work towards developing an automatic solution that enables eligible ecosystem participants to easily apply for the Legal Defense Process.
If no automatic process is in place, of if the process doesn't function correctly, the Physical Resilience Facilitator must process the request manually, and must publish an easy to understand guide for how to apply through the manual process.
---
...
* Claim approval
* Reimbursement
  * **3.4.5.1:** *Legal Counsel Pre-approval*
The first step in the claim management process is to approve the Legal Counsel that will undertake legal defense or legal representation.
Beneficiary presents [Quote] from the law firm they selected for their legal defense / representation. The Quote must indicate, at least:
* Name of Legal Counsel
* Name of Law Firm
* If not in [Lawyer Registry], Proof of Eligibility
* Quote, which must include a global estimated fee OR hourly fee + estimation fixed amount to be charged for each of the stages/instances of the defense process
    * **3.4.5.1.1:** If the Legal Counsel is LDF qualified in the Lawyer Registry (1.1.1.2.4), the claim is automatically pre approved.
    * **3.4.5.1.2:** If Legal Counsel is NOT LDF qualified in the Lawyer Registry (1.1.1.2.4), then the Physical Resilience Facilitators verifies if the Legal Counsel complies with requisites in 1.1.1.2.1 (Lawyer Registry Acceptance Criteria) and 1.1.1.2.4 (Legal Defense Fund Acceptance Criteria). 
      * **3.4.5.1.2.1:** If the Legal Counsel of the claim is found to comply with the requirements, the claim is pre-approved and the legal counsel is added to the LR. 
      * **3.4.5.1.2.2:**If the Legal Counsel pf the claim doesn’t comply with the LR requirements, the claim is rejected and the Beneficiary must propose a different Legal Counsel.
...
* Supportive Documentation
  * Law firm’s proposal and invoice
  * Copy of the Lawsuit / writ issued by a Court or Governmental Agency
...
If the governance poll for paying out a claim is successful, an executive vote must be created to to draw the funds from the Surplus buffer and send them to to the Beneficiary's registered wallet. The spend must be accounted for in the active element of the relevant budget.
