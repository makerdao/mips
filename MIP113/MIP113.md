...
To become recognized as an Unaffiliated AVC Member or to join an existing AVC, an Ecosystem Actor must post a recognition submission message publicly on the Maker Governance Forum."
...
An Unaffiliated AVC Member may join an AVC through the process described in *MIP113 5.2.1.2.4* or start a new AVC through the process described in *MIP101 2.5.3*.
