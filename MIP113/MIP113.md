...
* **4.2.2:** The Arbitration Facilitators must maintain the list of CVC Members is contained in *4.2.2.1A*.
	* **4.2.2.1A:**
...
* **4.2.3:** The Arbitration Facilitators must unrecognize any CVC Member that has not maintained at least 10 MKR in their recognized ethereum address as soon as they become aware of this.
...
* **4.4.5:** The list of all CVCs is contained in *4.6.4.1A*, broken down by current status. The Arbitration Facilitators must keep the list current based on CVC creation, adherence with requirements, and CVC Decisions.
	* **4.6.4.1A:**
...
* **5.2.1:** Constitutional Delegates must be recognized by the Arbitration Facilitators if they fulfil the following requirements.
...
* **5.4.5:** Payout of CD income is done monthly by the Arbitration Facilitators bundling MKR payments into an Executive Vote.
