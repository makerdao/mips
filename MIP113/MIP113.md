...
---
* **4.5.2:** CVC Decisions are voted on during a one week period. CVC Members vote by posting a signed message referring the proposal and containing either "For" or "Against". Voting weight is based on the verified MKR of the CVC Member.
---
...
* **5.7.1:** There are two levels of CD income: Prime Constitutional Delegates (PCDs) and Reserve Constitutional Delegates (RCDs).
	* **5.7.1.1:** The top 7 qualifying CDs by number of combined MKR delegated to their delegate contracts are the PCDs.
	* **5.7.1.2:** The top 8.14 qualifying CDs by number of combined MKR delegated to their delegate contracts are the RCDs.
* **5.7.2:** When eligible for CD income, the PCDs and RCDs still have to meet specific participation requirements in CVCs.
	* **5.7.2.1:** PCDs must participate in at least 16 CVC Subcommittee Meetings per month.
	* **5.7.2.2:** RCDs must participate in at least 4 CVC Subcommittee Meetings per month.
---
