...
To become recognized as a Constitutional Delegate, an Ecosystem Actor must post two signed messages on the Maker Governance Forum that together make up their CD Recognition Submission. 
* **5.2.1:** CDs must deploy exactly 2 Protocol Delegation System smart contracts, and decide which CVC Governance Strategy each of them follow.
* **5.2.2:** Each message must contain the address of the delegate system contract, the followed CVC Governance Strategy, and the address controlling the delegation system contract.
* **5.2.3:** Each message must be signed by the address controlling the delegation system contract.
* **5.2.4:** The CD Recognition Submission template is as follows, an instance must be posted to the Maker Governance forum for each delegation contract.
	* **5.2.4.1:**
```
CD Recognition Submission: X/2
[CD Identifier]
[Controlling Address]
[Ethereum address of Delegation Contract]:[Followed CVC]
[Cryptographic signature of message]
```
---
...
* **5.3.1:** The list of all current recognized CDs is maintained in *5.3.1.1A*. It is updated in real time by the Arbitration Facilitators as they process and accept CD Recognition Submissions.
	* **5.3.1.1A:**
    ...
    | CD Identifier | Delegation Contract 1 | Followed CVC 1 | Delegation Contract 2 | Followed CVC 2 |
    |---|---|---|---|---|
    | N/A | N/A | N/A | N/A | N/A |
