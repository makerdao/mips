...
In the event that the Governance Facilitators cannot reach a majority decision regarding an Atlas interpretation, a formal vote shall be triggered involving the broader Maker Governance community. This vote will aim to resolve the ambiguity and determine the interpretation. The outcome of this community vote shall be binding and serve as the official interpretation.

#### 2.2.5

Atlas Interpretation precedent made directly by the Governance Facilitators is contained in 2.2.5.1A.
...
At the end of the review period, the Governance Facilitators will post their response to the Scope Artifact Appeal request on the Maker Forum, along with the rationale for the decision. The post will also indicate which Facilitators voted for and against the majority decision.
...
Derecognition notices shall be issued in a public manner, ensuring transparency and accountability. The issuing Governance Facilitator must provide comprehensive justification and reasoning for the derecognition, clearly stating the specific rules violated from the code of conduct pertinent to the role(s) the Alignment Conserver in question has assumed.

#### 4.1.2

The Governance Facilitators are responsible for developing a detailed code of conduct that unambiguously defines the behaviors considered violations for each role an Alignment Conserver can assume, including but not limited to Aligned Voter Committee Members, Aligned Delegates, Facilitators, and Budget Allocators. This development process should involve active consultations, meetings, and/or surveys with the various ecosystem actors to ensure a thorough understanding of the behaviors that should be prohibited. The code of conduct must be reviewed and updated periodically to adapt to evolving norms and standards.

#### 4.1.3

Upon the finalization of the derecognition process, the known aliases, and associated entities of the derecognized Alignment Conserver shall be recorded in a dedicated register, referred to in Article 4.1.4A. This register must be maintained with up-to-date information and be accessible to relevant parties as prescribed by the governance protocols.

#### 4.1.4A: Derecognized Alignment Conservator Register
...
An AVC that has failed to fulfill the requirements under 5.2.4 for two consecutive quarters, or at any time of the quarter runs out of active members, is no longer considered an AVC and is removed from the list in *5.2.4.7.1A*.

---

##### 5.2.4.6

An active AVC Member is the one that fulfills the following requirements. These general requirements are intentionally designed to be open-ended to allow AVCs and Governance Facilitators the flexibility to set their own interpretation of each:

- **Regular Participation**: It regularly attends subcommittee meetings and is present in discussions and activities related to the subcommittee.
- **Substantial Contribution**: Actively and substantially contributes to the work of the subcommittee.
- **Collaboration**: Works effectively as part of a team and collaborates with other members to achieve the subcommittee's goals.
- **Commitment to Subcommittee Goals**: Demonstrates a strong commitment to the objectives and mission of the subcommittee and works.
- **Active Communication**: Maintains open and effective communication with other subcommittee members and the aligned delegates.

##### 5.2.4.7

AVC Members who choose to become inactive must provide at least one month's notice before ceasing attendance at subcommittee meetings. Failure to meet this requirement will result in the AVC member being ineligible for rewards in the subsequent quarter.

##### 5.2.4.8

The list of all AVC is contained in 5.2.4.8.1A, broken down by current status. The Arbitration Facilitators must keep the list current based on AVC creation, adherence with requirements, and AVC Decisions.
...
| opensky | [0x8e67ee3bbeb1743dc63093af493f67c3c23c6f04](https://etherscan.io/address/0x8e67ee3bbeb1743dc63093af493f67c3c23c6f04) | [Link](https://forum.makerdao.com/t/cvc-membership-registration/20446/2) | [Link](https://etherscan.io/verifySig/16668) | 1.600 ||
...
After being recognized, and as long as 0 MKR is delegated to one of the Protocol Delegation System smart contract, the Aligned Delegate can redirect that contract to another AVC Governance Strategy by providing a submission message and posting it on the forum.

###### 6.2.1.2.2

After being recognized, and if more than 0 MKR is delegated to one of the Protocol Delegation System smart contract, the Aligned Delegate will be able to change its following AVC Governance Strategy for that contract by deploying a new Protocol Delegation System Smart Contract.

In this case, the Aligned Delegate will have to submit a forum post indicating which new AVC will be followed through the new Governance Strategy Link (GSL). A statement should be included specifying that it is breaking the Strategic Governance Link with the AVC that is not longer beign followed. 
...
If an AVC is no longer considered an AVC as per subcomponent **5.2.4.5**, all its following Aligned Delegates have 1 week from when the AVC is removed from the list in *5.2.4.7.1A* to deploy a new Protocol Delegation System smart contract and signal a new AVC that they wish to follow. If no MKR was delegated to the old Protocol Delegation System smart contract, the Aligned Delegate can proceed as per **6.2.1.2**. The old Protocol Delegation System smart contract becomes neutral.
...
### 6.4: Aligned Delegate Response Drills

#### 6.4.1

Irregular Aligned Delegate response drills should be run by Governance Scope Facilitators in order to empirically measure likely delegate response times in various emergency scenarios. Drills must take place four times a year, spread irregularly over the period.

#### 6.4.2

Aligned Delegates are expected to respond in a satisfactory time to at least 75% of the drills. The satisfactory time will be decided by Governance Scope Facilitators depending on each drill. Governance Scope Facilitators will measure, record and public response statistics.

#### 6.4.3

The Governance Facilitators shall be required, upon the enforcement of this policy, to establish, communicate, and initiate the drill system within 3 months.

### 6.5: Anon friendly Aligned Delegates Notification Process

#### 6.5.1

Ensuring that Governance Facilitators can promptly and efficiently alert Aligned Delegates during emergencies is crucial. For that, an Anon-Friendly Delegate Notification Process must be developed.

#### 6.5.2

The Governance Facilitators shall be required, upon the enforcement of this policy, to establish, communicate, and initiate the Anon-Friendly Aligned Delegate Notification Process within 3 months.
