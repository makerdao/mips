...
To become recognized as an Unaffiliated AVC Member, an Ecosystem Actor must post a recognition submission message publicly on the Maker Governance Forum, as described 5.2.1.1, 5.2.1.2, 5.2.1.3 and 5.2.1.4.
...
[Ethereum address]
[Cryptographically signed AVC Member Recognition Message]5.2.1.5
```
