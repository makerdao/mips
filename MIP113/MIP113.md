...
##### 5.2.4.2: An AVC is marked as _active_ status if it has fulfilled every requirement under *4.3* in the previous quarter.  
---
##### 5.2.4.3: An AVC is marked as _inactive_ status if it has failed to fulfill the requirements under *4.3* for the most recent quarter, but has fulfilled the requirements for one or more prior quarters.  
---
##### 5.2.4.4: An AVC is marked as _pending_ status if it has been in existence for less than one full quarter.  
---
