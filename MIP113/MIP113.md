...
An AVC is marked as _inactive_ status if it has failed to fulfill the requirements under *MIP101 2.5.4* for the most recent quarter, but has fulfilled the requirements for one or more prior quarters.
