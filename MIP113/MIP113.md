...
* **4.2.1:** To become recognized as a CVC Member, an Ecosystem Actor must post a recognition submission message publicly on the Maker Governance Forum.
	...
	* **4.2.1.2:** A recognition submission message must be cryptographically signed by an Ethereum address containing at least 10 MKR.
...
* **4.2.2:** The Arbitration Facilitators must maintain the list of CVC Members contained in *4.2.2.1A*.
	* **4.2.2.1A:**
...
* **5.4.1:** Prime Constitutional Delegates (PCDs)
	...
	* **5.4.1.2:** To qualify as PCDs, CDs must participate in at least 16 CVC Subcommittee Meetings per month.
	* **5.4.1.3:** The 7 PCD slots share a total of 2000 MKR per year, equivalent to 285.7 MKR per year for each PCD, or 23.8 MKR per month for each PCD.
...
* **5.4.2:** Reserve Constitutional Delegates (RCDs)
	...
	* **5.4.2.2:** To qualify as RCDs, CDs must participate in at least 4 CVC Subcommittee Meetings per month.
