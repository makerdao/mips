...
AVCs can elect one member as an AVC moderator via an AVC decision. The vote for this AVC decision excludes the current moderator if there is one. The moderator can confirm a limited subset of AVC decisions unilaterally but must tag all other AVC members in the decision message for the decision to be considered valid. These decisions are deemed valid after a period of 72 hours without a veto by any other member of the AVC. Vetoes are posted to to the forum via a signed message.

Moderators are elected on a quarterly basis.
