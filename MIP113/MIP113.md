...
* **1.2.3:** The resolution of constitutional ambiguity or disputes must clearly set new precedent that prevents a similar ambiguous situation from occuring in the future.  

* **1.2.4:** If the existence or proposed resolution of an ambiguity becomes contentious, one or more MKR votes may be initiated by the Responsible Facilitators to resolve the contention.  

##### 1.3 Constitutional Intepretation Process
* **1.3.1:** Constitutional Interpretation precedent may be made directly by the Responsible Facilitators of the Arbitration Scope without any MKR vote.
	* **1.3.1.1:** Constitutional Interpretation precedent made directly by the Responsible Facilitators must be recorded as a subelement to the Active Element *1.3.3A*.
	* **1.3.1.2:** Entries to Active Element *1.3.3A* through *1.3.1* must denote the source of the precedent as 'Arbitration Direct'.
	
* **1.3.2:** Constitutional Interpretation precedent may be made according to the outcome of an MKR vote initiated by the Responsible Facilitators of the Arbitration Scope.
	* **1.3.2.1:** Any MKR vote on constitutional precedent must contain a proposed change to the wording of the constitution which is limited to resolution the ambiguity.
	...
	* **1.3.2.6:** With the exception of the other elements under *1.3.2*, any MKR vote intended to resolve ambiguity in the Constitution may be structured freely by the Responsible Facilitators.
...
* **2.2.3:** Scope Framework appeal proposals must be reviewed by the Responsible Facilitators.  

* **2.2.4:** Scope Framework appeal proposals must be declared valid or invalid by the Responsible Facilitators. Declaration and reasoning must be publicly communicated.  

* **2.2.5:** Scope Framework appeal proposals must be declared accepted or rejected by the Responsible Facilitators. Declaration and reasoning must be publicly communicated.  
...
* **2.3.1:** The Responsible Facilitators may directly edit a Scope Framework to align its content with the constitutional boundaries and any other constitutional requirements. Changes and reasoning must be publicly communicated.  

* **2.3.2:** The Responsible Facilitators may initiate an MKR vote to ratify an edit to a Scope Framework that resolves the issue(s) that triggered a valid, accepted Scope Framework appeal.
...
Constitutional Conservers are Ecosystem Actors that adhere to a set of constitutional requirements. Membership of the Constitutional Conservers is managed by the Responsible Facilitators according to strict rules.
...
* **3.3.1:** The Responsible Facilitators are responsible for recognizing Constitutional Conservers. The process of obtaining recognition is specific to each type of Constitutional Conserver.  

* **3.3.2:** The Responsible Facilitators must derecognize Constitutional Conservers that they determine have meaningfully broken the Constitutional Conserver adherence requirements specified in *3.2*.  

* **3.3.3:** A Constitutional Conserver may only be Recognized in one Constitutional Conserver role at any one time.  

* **3.3.4:** Derecognition of an Ecosystem Actor identity can be done by a Responsible Facilitator of the Arbitration Scope, by directly adding them to the Active Element *3.3.1.1A*.
	* **3.3.1.1A:**
...
If a Constitutional Conserver breaks the adherence requirements, but the Responsible Facilitators fail to derecognize them, the following fallback process may be used.
...
* **3.4.2:** The Responsible Facilitators must initiate an MKR vote to derecognize the identified Constitutional Conserver if the requirements of *3.4.1* are met.
	...
	* **3.4.2.2:** If the 'Yes' option achieves by majority, the Constitutional Conserver is derecognized, and the 10 MKR is returned to the source address.
...
* **4.2.1:** To become recognized as a CVC Member, an Ecosystem Actor must post a recognition submission message publicly on the Maker Governance Forum.
	* **4.2.1.1:** A recognition submission message must contain either: A) A list of cryptographic signatures from an existing CVC's members that represents a successful vote to onboard the Ecosystem Actor as a member of that CVC; or B) A clearly stated intention to form a new CVC.**
	* **4.2.1.2:** A recognition submission message must be be cryptographically signed by an Ethereum address containing at least 10 MKR.
	* **4.2.1.3:** A recognition submission message must use the template described in *4.2.1.4*.
	* **4.2.1.4:**
'''
...
* **4.2.2:** The Responsible Facilitators must maintain the list of CVC Members is contained in *4.2.2.1A*.
	* **4.2.2.1A:**
...
* **4.2.3:** The Responsible Facilitators must unrecognize any CVC Member that has not maintained at least 10 MKR in their recognized ethereum address as soon as they become aware of this.
...
* **4.3.2:** Every quarter, a CVC must produce a Governance Strategy Position Document.  
	* **4.3.2.1:** A Governance Strategy Position Document must provide general guidelines and values that can inform the voting behavior for Constitutional Delegates following the CVCs Governance Strategy across different situations.
...
##### 4.4: CVC management
The Responsible Facilitators must monitor and record the status of each CVC. 

* **4.4.1:** A CVC is marked as _active_ status if it has fulfilled every requirement under *4.3* in the previous quarter.  

* **4.4.2:** A CVC is marked as _inactive_ status if it has failed to fulfil the requirements under *4.3* for the most recent quarter, but has fulfilled the requirements for one or more prior quarters.  

* **4.4.3:** A CVC is marked as _pending_ status if it has been in existence for less than one full quarter.  

* **4.4.4:** A CVC that has failed to fulfil the requirements under *4.3* for two consequtive quarters is no longer considered a CVC and is removed from the list in *4.4.4.1A*.  

* **4.4.5:** The list of all CVCs is contained in *4.6.4.1A*, broken down by current status. The Responsible Facilitators must keep the list current based on CVC creation, adherence with requirements, and CVC Decisions.
	* **4.6.4.1A:**
...
* **4.6.3:** The Responsible Facilitators must monitor the participation of CVC Members and bundle the MKR rewards for qualifying CVC Members into Executive Votes each quarter.
...
* **5.2.1:** Constitutional Delegates must be recognized by the Responsible Facilitators if they fulfil the following requirements.
	* **5.2.1.1:** An Ecosystem Actor must publicly post a CD Recognition Submission message on the Maker Governance Forum.
	* **5.2.1.2:** An Ecosystem Actor must deploy exactly 2 Protocol Delegation System smart contracts, and specify which CVC Governance Strategy each of them follow as part of the submission message.
	* **5.2.1.3:** The submission message must be cryptographically signed by the deploying Ethereum address. 
	* **5.2.1.4:** The submission message must follow this template:
```
...
* **5.2.2:** A Constitutional Delegate must maintain a minimum level of activity, or lose its recognition as a Constitutional Delegate.
	* **5.2.2.1:** A CD must keep a minimum voting activity of 75% participation in all votes on average.
	* **5.2.2.2:** A CD must keep a minimum communication activity of having provided comments for 75% of all votes on average.

* **5.2.3:** A Constitutional Delegate must adhere to the requirements below, or lose its recognition as both a Constitutional Delegate and a Constitutional Conserver.
	...
	* **5.2.3.4:** CDs must not take actions that could be perceived to put the security of Maker Governance into jeopardy through politicization of the CD role.
	* **5.2.3.5:** CDs may not collaborate to influence Maker Governance in groups or structures outside of the CVCs.

* **5.2.4:** The current state of CDs is maintained by the Responsible Facilitators.
...
* **5.3.2:** The Responsible Facilitators must ensure the results of any Constitutional Delegate action are represented on the Easy Governance Frontend.

##### 5.4: Constitutional Delegate income management

The top 14 CDs that have the highest amount of combined MKR delegated to their delegate contracts, and meet minimum requirements, are eligible to receive CD income. There are two levels of CD income: Prime Constitutional Delegates (PCDs) and Reserve Constitutional Delegates (RCDs).

* **5.4.1:** Prime Constitutional Delegates (PCDs)
	* **5.4.1.1:** The top 7 qualifying CDs by number of combined MKR delegated to their delegate contracts are the PCDs.
	* **5.4.1.2:** CDs must participate in at least 16 CVC Subcommittee Meetings per month to qualify as PCDs.
	* **5.4.1.3:** The 7 PCD slots share a total of 2000 MKR per year amongst them, equivalent to 285.7 MKR per year for each PCD, or 23.8 MKR per month for each PCD.

* **5.4.2:** Reserve Constitutional Delegates (RCDs)
	* **5.4.2.1:** The top 7 qualifying CDs that are not PCDs by number of combined MKR delegated to their delegate contracts are the RCDs.
	* **5.4.2.2:** CDs must participate in at least 4 CVC Subcommittee Meetings per month to qualify as RCDs.
	* **5.4.2.3:** The 7 RCD slots share a total of 500 MKR per year amongst them, equivalent to 71.4 MKR per year for each RCD, or 5.95 MKR per month for each RCD.

* **5.4.3:** CD income payouts are modified by voting activity metrics for votes taking place since they were Recognized, and in the last 12 months.
	* **5.4.3.1:** If a CD has voted in less than 95% of votes, they receive a reduced amount of CD income.
	* **5.4.3.2:** The reduction in income is proportionally linear until it reaches 0 CD income at 75% voting activity.
	* **5.4.3.3:** If a CD falls below 75% voting activity, it receives no CD income.

* **5.4.4:** CD income payouts are modified by communication metrics for votes taking place since they were Recognized, and in the last 12 months.
	* **5.4.4.1:** To meet the communication requirement for a given vote, CDs must write an explanation of their vote that ties it to their Governance Strategy and their independent strategy.
	* **5.4.4.2:** If the CD meets the communication requirement on less than 95% of votes, they receive a reduced amount of CD income.
	* **5.4.4.3:** The reduction in income is proportionally linear until it reaches 0 CD income at 75% communication activity.
	* **5.4.4.4:** If a CD falls below 75% communication activity, it receives no CD income.

* **5.4.5:** Payout of CD income is done monthly by the Responsible Facilitators bundling MKR payments into an Executive Vote.
