...
* **4.4.1:** During the Pregame, any CVC Member can create a new CVC through a CVC creation message on the Maker Governance Forum based on the template of *4.4.1.1*. The new CVC must include a link to a draft Governance Strategy Position Document in the CVC creation message. New CVCs are active from when they are created.
    * **4.4.1.1:**
