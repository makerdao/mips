...
* **5.2.4:** The current state of CDs is maintained by the Arbitration Facilitators.
    ...
    * **5.2.4.2A:**
    ...
    | Delegate Name | Ecosystem Actor ETH Address | Verified Signature from EA Address | Delegation Contract 1 | Followed CVC 1 | Verified Signature Confirming Ownership of Delegation Contract 1 | Delegation Contract 2 | Followed CVC 2 | Forum Verification | Verified Signature Confirming Ownership of Delegation Contract 2 |
    |---|---|---|---|---|---|---|---|---|---|
