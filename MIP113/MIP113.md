...
The top 14 CDs with the highest combined MKR delegated to their delegate contracts, who also meet minimum requirements, are eligible to receive CD income. There are two levels of CD income: Prime Constitutional Delegates (PCDs) and Reserve Constitutional Delegates (RCDs). For the purposes of calculating Constitutional Delegtate income, only MKR delegated to the two recognized contracts that are following CVC strategies is counted, MKR delegated to permissionless delegate contracts controlled by the CD is _not_ counted.
