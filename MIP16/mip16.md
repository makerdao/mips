...
- Items will not be included in an executive vote until the following requirements have been met, this includes includes items proposed by Core Unit Facilitators:
   - For code inclusions, smart contract code must be provided to PE-001 by the appropriate Core Unit or counterparty at least two weeks prior to the requested executive vote going live to ensure it can be properly reviewed.
