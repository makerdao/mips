...
### 8.4: Ecosystem Communication Standards

Effective and transparent communication is vital for the functioning and trust of the MakerDAO community. These standards reflect Maker Governance commitment to its community through transparency and effective communication.

#### 8.4.1: Open Channel Commitment

All Ecosystem Actors, Advisory Council members, and subDAOs participating in the Maker Forum must maintain open channels of communication, especially when addressing queries or concerns from Alignment Conservers. When any of these entities are ‘tagged’ in a post or a discussion thread on the Maker Forum — indicated by directly mentioning their designated forum username or group — they are obligated to adhere to the communication standards outlined in 8.4. Stakeholders are also obligated to proactively inform the community of any significant communication delays

#### 8.4.2: Defined Response Time

To uphold community trust, specific response times are set for all stakeholders to acknowledge and address queries or concerns. Each stakeholder is required to clearly communicate their own response deadlines, ensuring these timelines are realistic and consistently met.

##### 8.4.2.1: Initial Acknowledgement

Stakeholders tagged in the Maker Forum must acknowledge any query or concern within 24-48 hours. This ensures that AVC members are aware their input is being considered.
