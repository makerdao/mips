...
The Ecosystem Scope Framework provides the core principles, rules and regulation regarding Real-World Asset Collateral in the Endgame.
...
* **4.2.1:** DAO Toolkit Core Development is funded through the budget defined in *4.2.1.1A*. This Active Element is modified using the standard CVC process
	* **4.2.1.1A:**
¤¤¤
The budget available to fund DAO Toolkit Core Development related tasks is:
0 Dai per quarter
¤¤¤
...
List of Incubating Ecosystem Actors:
        * **6.6.2.1A.1:** Phoenix Labs
          * **6.6.2.1A.1.1:** 347,100 DAI provided immediately upon a successful confirmation of the Incubating Ecosystem Actor in a Governance Poll.
TODO: Add monthly budget for full time Developer Relations role.
          * **6.6.2.1A.1.2:** Deliver the Spark Protocol and maintain it for 12 months.
          * **6.6.2.1A.1.3:** 1 Business Development, 1 Smart Contract developer, 1 Developer Relations.
       * **6.6.2.1A.1:** Viridian Protector Advisor Company
          * **6.6.2.1A.1.1:** 257,250 DAI provided immediately upon a successful confirmation of the Incubating Ecosystem Actor in a Governance Poll.
85,750 Dai per month for full team.
         * **6.6.2.1A.1.2:** Provide Protector Advisor work.
         * **6.6.2.1A.1.3:** Business Development, Risk Analyst, Lawyer.
      * **6.6.2.1A.1:** dewiz
          * **6.6.2.1A.1.1:** 150,000 DAI and 21 MKR per month.
         * **6.6.2.1A.1.2:** General smart contract development and Collateral Onboarding Technical work (RWA focused).
         * **6.6.2.1A.1.3:** 5 Smart Contract developers.
      * **6.6.2.1A.1:** Sidestream
          * **6.6.2.1A.1.1:** 70,912.5 DAI per month.
         * **6.6.2.1A.1.2:** Full stack smart contract and frontend development.
         * **6.6.2.1A.1.3:** 3.5 FTE full stack developers.
¤¤¤
...
* **6.7.1:** The Incubation Overhead budget is contained in *6.7.1.1A* and is modified through the regular CVC process.
	* **6.7.1.1A:**
¤¤¤
The Incubation Overhead budget is up to 0 Dai per quarter.
¤¤¤
* **6.7.2:** The Incubation budget is contained in *6.7.2.1A* and is modified through the regular CVC process.
	* **6.7.2.1A:**
¤¤¤
The Incubation budget is up to 0 Dai per quarter, and up to 0 MKR per quarter.
¤¤¤
...
* **8.2.1:** The ecosystem communication infrastructure budget is contained in *8.2.1.1A* and is modified through the regular CVC process.
	* **8.2.1.1A:**
¤¤¤
The ecosystem communication infrastructure budget is up to 0 Dai per quarter.
¤¤¤
