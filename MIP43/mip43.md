...
Fixed-rate loans from protocols like Yield Protocol may be able to help Maker fill the gap with the legacy financial system. This increases the utility of holding Dai and will help drive additional adoption. But, there are challenges. While very promising, the market to borrow and lend at a fixed-rate for long-term loans is new and nascent. And it is unclear whether a fixed-rate lending and borrowing market in Dai can succeed without encouragement from Maker. 

One challenge for fixed-rate borrowing in Dai today is the mismatch between stability fees and rates of return of Dai. The prevailing rates of return for providing Dai liquidity for yield farming has consistently exceeded 10-15% APY. Potential Dai lenders have been looking for comparable rates of return when considering making fixed-term Dai loans. Borrowers, meanwhile, are looking to borrow at rates that are comparable to the stability fee, which has generally been at 2.5% and under over the last few months. Given the wide gulf between borrowers and lenders, long-term loans are currently very illiquid. Unless ecosystem conditions change, fixed-rate borrowing and lending may struggle to gain adoption, without MakerDAO’s ability to issue cheaper financing.

This challenge for the fixed-rate market may be beneficial for Maker. If Maker were to enter the long-term fixed-rate market, it may be able to earn a higher rate of return on issued Dai. For example, yield farmers may be willing to pay a higher interest rate if they can lock in Dai funding for an extended period. Buying fyDai, then, might be considered a form of balance sheet optimization which has been a topic of interest in the Maker community lately (for example, see [this post examining makerdao accounting](https://forum.makerdao.com/t/makerdao-accounting-and-implications/5346)). 
