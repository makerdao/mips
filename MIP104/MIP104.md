...
The Dai Savings Rate is regularly updated to be equal to (Base rate - 0.6%). The up to date Dai Savings Rate is contained in *3.2.1A*. Whenever an update to the Dai Savings Rate occurs, the Stability Facilitator must trigger an executive vote to update the on-chain Dai Savings Rate.
...
###### 7.1.1.2.3: ALM Tier 2 Collateral or higher can be used for 80% of the AllocatorDAOs collateral portfolio with no Effective Junior Capital requirement.
...
###### 7.1.1.3.3: ALM Tier 3 Collateral or higher can be used for 65% of the AllocatorDAOs collateral portfolio with no Effective Junior Capital requirement.
...
###### 7.1.1.4.3: ALM Tier 4 Collateral or higher can be used for 40% of the AllocatorDAOs collateral portfolio with no Effective Junior Capital requirement.
...
#### 14.3.4: WSTETH-A. LR = 160%. Debt Ceiling Limit = Unlimited. Stability Fee = Dai Savings Rate + 0.25%.

#### 14.3.5: WSTETH-B. LR = 185%. Debt Ceiling Limit = Unlimited. Stability Fee = Dai Savings Rate.

#### 14.3.6: To protect the protocol from unnecessary complexity, the Stability Facilitators must offboard collateral types above if they fall below a total debt of 20 million.

#### 14.3.7: All other collateral types must be offboarded when the Stability Facilitators considers it appropriate, and when there are new mechanisms in place that can take over the role the offboarded collateral covered.
