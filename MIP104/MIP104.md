...
##### 5.1.1.1B: Fallback Process

If a legal structure that utilizes an Arranger subsequently has its Arranger removed, quit, or become unresponsive, then another Ecosystem Actor is temporarily assigned to continue the Arranger's existing duties for that legal structure.

An Ecosystem Actor is allowed to decline this responsibility.

This is done in the order below:

- Steakhouse Finance
- Active Arrangers, in order of the time spent in that role
- An Ecosystem Actor appointed by the Facilitator(s) responsible for MIP104

An Ecosystem Actor serving as a temporary Arranger is entitled to the same compensation amounts and schedule as the previous active Arranger. The Facilitator(s) responsible for MIP104 may propose in a standalone governance vote for additional compensation if that is required.

It is expected that a legal structure will either be unwound or be appointed an active Arranger as soon as is practical.

##### 5.1.1.1C Arranger Removal

When an Arranger is removed from the active Arranger list in *5.1.1.1A*, they must immediately coordinate with the Facilitator(s) responsible for MIP104 to transition all control, access, documents, and other items or information needed to secure legal and financial control of the legal structures they are responsible for.

Upon completion of the above, and after public certification of that completion by the Facilitator(s) responsible for MIP104, the Arranger may be given an offboarding payment. This payment is at the discretion of the MIP104 Facilitator(s), but may not be more than the Arranger's fees over the previous six months.
