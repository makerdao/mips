...
The Responsible Facilitators of the Growth Scope are responsible for adhering to the contents of the Scope Framework elements.
...
The Responsible Facilitator Core Units for the Growth Scope are defined in MIP108c3.

## MIP108c4: Active Responsible Facilitator Core Unit list

The current active Responsible Facilitator Core Units of the Growth Scope are:
* TBD

## MIP108c5: Active Responsible Facilitator Core Unit list modification sub proposal process

This component is a sub proposal process component that, if approved by Maker Governance, modifies the state of MIP108c4 from line 14 until the end of the MIP Component.
