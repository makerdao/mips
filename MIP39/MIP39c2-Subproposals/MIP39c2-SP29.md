# MIP39c2-SP29: Adding TechOps Core Unit (TOCU-001)
...
Tags: core-unit, cu-tocu-001, mandate
Status: RFC
...
MIP39c2-SP29 adds the TechOps Core Unit (TOCU-001) to handle the system administration and technical support needs of the Maker Protocol and its Core Units.
...
_Note:_ Due to the limited number of FTE resources and costly cloud infrastructure (see Budget MIP), it is up to the TOCU-001 to triage incoming requests and, in some cases, to declare work as out of scope and infrastructure not critical. Basically TOCU-001 will not use DAO funds lightly to support non-critical infrastructure.
